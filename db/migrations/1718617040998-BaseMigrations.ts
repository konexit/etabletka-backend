...
export class BaseMigrations1718617040998 implements MigrationInterface {
    name = 'BaseMigrations1718617040998'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "product_remnants" ADD "quantity" numeric NOT NULL DEFAULT '0'`);
