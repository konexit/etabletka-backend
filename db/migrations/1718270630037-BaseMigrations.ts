...
export class BaseMigrations1718270630037 implements MigrationInterface {
    name = 'BaseMigrations1718270630037'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "blog-comments" ("id" SERIAL NOT NULL, "post_id" integer NOT NULL, "user_id" integer NOT NULL, "comment" text NOT NULL, "is_approved" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_1370a7e4456fd6a6f91376117c3" PRIMARY KEY ("id"))`);
        await queryRunner.query(`ALTER TABLE "blog_posts" DROP COLUMN "comments_count"`);
        await queryRunner.query(`ALTER TABLE "blog_posts" DROP COLUMN "views_count"`);
        await queryRunner.query(`ALTER TABLE "products" ADD "cdn_data" json`);
        await queryRunner.query(`ALTER TABLE "products" ADD "morion_code" integer NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "blog_posts" ADD "cdn_data" json`);
        await queryRunner.query(`ALTER TABLE "blog-comments" ADD CONSTRAINT "FK_52742190272d7097205aac2aae0" FOREIGN KEY ("post_id") REFERENCES "blog_posts"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "products_categories" DROP CONSTRAINT "FK_f2c76a4306a82c696d620f81f08"`);
        await queryRunner.query(`ALTER TABLE "products_categories" DROP CONSTRAINT "FK_19fe0fe8c2fcf1cbe1a80f639f1"`);
        await queryRunner.query(`ALTER TABLE "blog-comments" DROP CONSTRAINT "FK_52742190272d7097205aac2aae0"`);
        await queryRunner.query(`ALTER TABLE "blog_posts" DROP COLUMN "cdn_data"`);
        await queryRunner.query(`ALTER TABLE "products" DROP COLUMN "morion_code"`);
        await queryRunner.query(`ALTER TABLE "products" DROP COLUMN "cdn_data"`);
        await queryRunner.query(`ALTER TABLE "blog_posts" ADD "views_count" integer NOT NULL DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "blog_posts" ADD "comments_count" integer NOT NULL DEFAULT '0'`);
