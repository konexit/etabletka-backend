...
export class BaseMigrations1724742603005 implements MigrationInterface {
    name = 'BaseMigrations1724742603005'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "products" ("id" SERIAL NOT NULL, "sync_id" integer NOT NULL, "company_id" integer, "brand_id" integer, "name" json NOT NULL, "short_name" json NOT NULL, "atc" character varying, "slug" character varying NOT NULL, "cdn_data" json, "cdn_instruction" json, "instruction_uk" character varying, "instruction_ru" character varying, "instruction_en" character varying, "seo_h1" json, "seo_title" json, "seo_description" json, "price" double precision NOT NULL DEFAULT '0', "reviews_count" integer NOT NULL DEFAULT '0', "rating" integer NOT NULL DEFAULT '0', "active" boolean NOT NULL DEFAULT false, "hidden" boolean NOT NULL DEFAULT false, "in_stock" boolean NOT NULL DEFAULT false, "is_prescription" boolean NOT NULL DEFAULT false, "product_type_id" integer NOT NULL DEFAULT '1', "morion_code" integer NOT NULL DEFAULT '0', "attributes" jsonb, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_ddc2d911fb38cf805f685ae4a14" UNIQUE ("sync_id"), CONSTRAINT "UQ_464f927ae360106b783ed0b4106" UNIQUE ("slug"), CONSTRAINT "PK_0806c755e0aca124e67c0cf6d7d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "site_options" ("id" SERIAL NOT NULL, "key" character varying(125) NOT NULL, "title" character varying(125) NOT NULL, "value" text, "json" jsonb, "type" character varying(125) NOT NULL, "primary" smallint NOT NULL, "switchable" smallint NOT NULL, "active" smallint NOT NULL DEFAULT '1', "editable" smallint NOT NULL DEFAULT '1', "position" integer NOT NULL, "group" character varying(125), "group_title" character varying(125), "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_979d2c76702fe3ca1dd782fd9ab" UNIQUE ("key"), CONSTRAINT "PK_d274d6df319415c6e4b5ca76759" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "blog_categories" ("id" SERIAL NOT NULL, "title" json NOT NULL, "slug" character varying NOT NULL, "seo_h1" json, "seo_title" json, "seo_description" json, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_903a6ea496e83ba9bec10af5835" UNIQUE ("slug"), CONSTRAINT "PK_1056d6faca26b9957f5d26e6572" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "blog_posts" ("id" SERIAL NOT NULL, "author_id" integer NOT NULL, "censor_id" integer NOT NULL, "published_at" date NOT NULL, "title" json NOT NULL, "slug" character varying NOT NULL, "excerpt" json, "content" json, "alt" json, "cdn_data" json, "seo_h1" json, "seo_title" json, "seo_description" json, "published" boolean NOT NULL DEFAULT false, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_5b2818a2c45c3edb9991b1c7a51" UNIQUE ("slug"), CONSTRAINT "PK_dd2add25eac93daefc93da9d387" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "cross_badges_products" ("badgesId" integer NOT NULL, "productsId" integer NOT NULL, CONSTRAINT "PK_80f3938d9a3b91785fb09bd36c5" PRIMARY KEY ("badgesId", "productsId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_b2c4e72dd5935c9378d6ac40ba" ON "cross_badges_products" ("badgesId") `);
        await queryRunner.query(`CREATE INDEX "IDX_0ef23428c242b523a188c659a9" ON "cross_badges_products" ("productsId") `);
        await queryRunner.query(`CREATE TABLE "cross_discounts_groups" ("discountGroupsId" integer NOT NULL, "discountsId" integer NOT NULL, CONSTRAINT "PK_132921eceef631075c071071704" PRIMARY KEY ("discountGroupsId", "discountsId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_fc2397564ae08fadf745536297" ON "cross_discounts_groups" ("discountGroupsId") `);
        await queryRunner.query(`CREATE INDEX "IDX_702c3dcb2dee458d0a43bcf715" ON "cross_discounts_groups" ("discountsId") `);
        await queryRunner.query(`CREATE TABLE "cross_discounts_products" ("discountsId" integer NOT NULL, "productsId" integer NOT NULL, CONSTRAINT "PK_3347ceb98107f5e459e2bc590e3" PRIMARY KEY ("discountsId", "productsId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_0a3c12eb0de93f48ba9e83c499" ON "cross_discounts_products" ("discountsId") `);
        await queryRunner.query(`CREATE INDEX "IDX_fab9b72a78aeb5622959720328" ON "cross_discounts_products" ("productsId") `);
        await queryRunner.query(`CREATE TABLE "cross_groups_products" ("productGroupsId" integer NOT NULL, "productsId" integer NOT NULL, CONSTRAINT "PK_ef4beedfd9298b6a147b9985cc7" PRIMARY KEY ("productGroupsId", "productsId"))`);
        ...
        await queryRunner.query(`CREATE TABLE "cross_blog_categories_posts" ("blogCategoriesId" integer NOT NULL, "blogPostsId" integer NOT NULL, CONSTRAINT "PK_4b67aa6a17cbcd9338bd07f320c" PRIMARY KEY ("blogCategoriesId", "blogPostsId"))`);
        await queryRunner.query(`CREATE INDEX "IDX_f9b0e2deaab82f1c3b02f3289e" ON "cross_blog_categories_posts" ("blogCategoriesId") `);
        await queryRunner.query(`CREATE INDEX "IDX_52cfdc0f7b1eb8b28bd3a622a2" ON "cross_blog_categories_posts" ("blogPostsId") `);
        ...
        await queryRunner.query(`ALTER TABLE "cross_badges_products" ADD CONSTRAINT "FK_b2c4e72dd5935c9378d6ac40ba9" FOREIGN KEY ("badgesId") REFERENCES "badges"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "cross_badges_products" ADD CONSTRAINT "FK_0ef23428c242b523a188c659a9c" FOREIGN KEY ("productsId") REFERENCES "products"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "cross_discounts_groups" ADD CONSTRAINT "FK_fc2397564ae08fadf7455362975" FOREIGN KEY ("discountGroupsId") REFERENCES "discount_groups"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "cross_discounts_groups" ADD CONSTRAINT "FK_702c3dcb2dee458d0a43bcf7159" FOREIGN KEY ("discountsId") REFERENCES "discounts"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "cross_discounts_products" ADD CONSTRAINT "FK_0a3c12eb0de93f48ba9e83c4996" FOREIGN KEY ("discountsId") REFERENCES "discounts"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "cross_discounts_products" ADD CONSTRAINT "FK_fab9b72a78aeb56229597203283" FOREIGN KEY ("productsId") REFERENCES "products"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        ...
        await queryRunner.query(`ALTER TABLE "cross_blog_categories_posts" ADD CONSTRAINT "FK_f9b0e2deaab82f1c3b02f3289e4" FOREIGN KEY ("blogCategoriesId") REFERENCES "blog_categories"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "cross_blog_categories_posts" ADD CONSTRAINT "FK_52cfdc0f7b1eb8b28bd3a622a27" FOREIGN KEY ("blogPostsId") REFERENCES "blog_posts"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "cross_blog_categories_posts" DROP CONSTRAINT "FK_52cfdc0f7b1eb8b28bd3a622a27"`);
        await queryRunner.query(`ALTER TABLE "cross_blog_categories_posts" DROP CONSTRAINT "FK_f9b0e2deaab82f1c3b02f3289e4"`);
        ...
        await queryRunner.query(`ALTER TABLE "cross_discounts_products" DROP CONSTRAINT "FK_fab9b72a78aeb56229597203283"`);
        await queryRunner.query(`ALTER TABLE "cross_discounts_products" DROP CONSTRAINT "FK_0a3c12eb0de93f48ba9e83c4996"`);
        await queryRunner.query(`ALTER TABLE "cross_discounts_groups" DROP CONSTRAINT "FK_702c3dcb2dee458d0a43bcf7159"`);
        await queryRunner.query(`ALTER TABLE "cross_discounts_groups" DROP CONSTRAINT "FK_fc2397564ae08fadf7455362975"`);
        await queryRunner.query(`ALTER TABLE "cross_badges_products" DROP CONSTRAINT "FK_0ef23428c242b523a188c659a9c"`);
        await queryRunner.query(`ALTER TABLE "cross_badges_products" DROP CONSTRAINT "FK_b2c4e72dd5935c9378d6ac40ba9"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_52cfdc0f7b1eb8b28bd3a622a2"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_f9b0e2deaab82f1c3b02f3289e"`);
        await queryRunner.query(`DROP TABLE "cross_blog_categories_posts"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_fab9b72a78aeb5622959720328"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_0a3c12eb0de93f48ba9e83c499"`);
        await queryRunner.query(`DROP TABLE "cross_discounts_products"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_702c3dcb2dee458d0a43bcf715"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_fc2397564ae08fadf745536297"`);
        await queryRunner.query(`DROP TABLE "cross_discounts_groups"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_0ef23428c242b523a188c659a9"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b2c4e72dd5935c9378d6ac40ba"`);
        await queryRunner.query(`DROP TABLE "cross_badges_products"`);
