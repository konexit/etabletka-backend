...
export class BaseMigrations1718289605913 implements MigrationInterface {
    name = 'BaseMigrations1718289605913'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "product_types" ADD "sync_id" integer`);
        await queryRunner.query(`ALTER TABLE "product_types" ADD CONSTRAINT "UQ_5d5e9a0583fb639e7181241b90b" UNIQUE ("sync_id")`);
        ...
        await queryRunner.query(`ALTER TABLE "blog_posts" DROP CONSTRAINT "REL_c3fc4a3a656aad74331acfcf2a"`);
        await queryRunner.query(`ALTER TABLE "blog_posts" DROP CONSTRAINT "REL_09cc83bdfa111d9031aa0c64c6"`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "blog_posts" DROP CONSTRAINT "FK_09cc83bdfa111d9031aa0c64c64"`);
        await queryRunner.query(`ALTER TABLE "blog_posts" DROP CONSTRAINT "FK_c3fc4a3a656aad74331acfcf2a9"`);
        await queryRunner.query(`ALTER TABLE "blog_posts" ADD CONSTRAINT "REL_09cc83bdfa111d9031aa0c64c6" UNIQUE ("censor_id")`);
        await queryRunner.query(`ALTER TABLE "blog_posts" ADD CONSTRAINT "REL_c3fc4a3a656aad74331acfcf2a" UNIQUE ("author_id")`);
        await queryRunner.query(`ALTER TABLE "blog_posts" ADD CONSTRAINT "FK_09cc83bdfa111d9031aa0c64c64" FOREIGN KEY ("censor_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "blog_posts" ADD CONSTRAINT "FK_c3fc4a3a656aad74331acfcf2a9" FOREIGN KEY ("author_id") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "product_types" DROP CONSTRAINT "UQ_5d5e9a0583fb639e7181241b90b"`);
        await queryRunner.query(`ALTER TABLE "product_types" DROP COLUMN "sync_id"`);
